...
<div class="content">
    <div class="wrapper">
        ...
        <hr class="line-right">
        <div class="main">
            <h1 class="title">关于网站</h1>
            <div class="year">
                <h2><a href="#">网站介绍<i></i></a></h2>
                <div class="list">
                    <ul>
                        <li class="cls highlight">
                            <p class="date">开发17年10月-12月</p>
                            <p class="intro">小错的博客上线</p>
                            <p class="version">&nbsp;</p>
                            <div class="more">
                                <p>${webContent.webContent}</p>
                            </div>
                        </li>
                    </ul>
                </div>
            </div>
            <c:forEach var="webDev" items="${webDevList}">
            <div class="year">
                <h2><a href="#">${webDev.year}年<i></i></a></h2>
                <div class="list">
                    <ul>
                        <c:forEach var="dev" items="${webDev.webDevelopList}" varStatus="cx">
                            <c:if test="${cx.index%3==0}">
                                <li class="cls highlight">
                                    <p class="date"><fmt:formatDate value="${dev.webCreateDate}" pattern="yyyy年MM月dd日"/></p>
                                    <p class="intro">${dev.webTitle}</p>
                                    <p class="version">&nbsp;</p>
                                    <div class="more">
                                        <p>${dev.webContent}</p>
                                    </div>
                ...
                <div class="list">
                    <ul>
                        <li class="cls highlight">
                            ...
                            <p class="version">&nbsp;</p>
                            <div class="more">
                                <p>首创微信集商务、娱乐一体化多媒体智能终端机微美图打印机营销推广活动支持导入SN码
                                微商城模板，支持分类列表
                                微商城完整支持微信支付
                                微商城数据统计显示顺序更正
                                微商城支持商品预览
                                微商城订单成功后，网页将收到新订单通知
                                幸运机活动时间延长至三个月等6个改进及Bug</p>
                            </div>
                        </li>
                        <li class="cls">
...
<div class="footer">
    <div class="footer-content clearfix">
        <div class="copyright" style="text-align: center">Copyright © 2018 LiZiTao lztizfl.com All Rights Reserved.</div>
    </div>
</div>
